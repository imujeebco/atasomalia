class MultiCityFlightModel {
  ...
  MultiCityFlightModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class Flights {
  ...
  Flights.fromJson(Map<String, dynamic> json) {
    ...
    outBound = json['outBound'] != null ? new OutBound.fromJson(json['outBound']) : null;
